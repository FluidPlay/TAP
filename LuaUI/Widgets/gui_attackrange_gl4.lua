...
local function CycleUnitDisplay(direction)
	...
	local soundEffect = 'Sounds/commands/alien-weapon.wav' --cmd-defaultweapon.wav
	local soundEffectOn = 'Sounds/commands/beep4_decrackled' --cmd-on.wav'
	local soundEffectOff = 'Sounds/commands/talk.wav' --cmd-off
	local volume = 0.3
