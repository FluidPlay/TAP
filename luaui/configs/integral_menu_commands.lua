...
--
	...
	cordlt		= {order = 6, row = 1, col = 6},
	corshred	= {order = 7, row = 2, col = 1},
	cordoom_stub = {order = 8, row = 2, col = 2},
	cordoom		= {order = 8, row = 2, col = 2},
	corint_stub = {order = 9, row = 2, col = 3},
	corint		= {order = 9, row = 2, col = 3},
	corfmd		= {order = 10, row = 2, col = 4},
	corsilo_stub = {order = 11, row = 2, col = 5},
	corsilo		= {order = 11, row = 2, col = 5},
	corgate		= {order = 12, row = 2, col = 6},
	cortoast	= {order = 13, row = 3, col = 1},
	cortron		= {order = 14, row = 3, col = 2},
	corsonar	= {order = 15, row = 3, col = 3},
	corshroud	= {order = 16, row = 3, col = 4},
	corerad		= {order = 17, row = 3, col = 5},
	cordrag		= {order = 18, row = 3, col = 6},
