...
local useChiliOld = true
useChiliOld = Spring.GetModOptions() and (tonumber(Spring.GetModOptions().mo_chiliold) == 1)
CHILI_DIRNAME = DIR .. (useChiliOld and "chili_old/" or "chili/")
