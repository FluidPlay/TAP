...
function widget:Initialize()
    Spring.Echo("Auto-initializing widgets (TAP)")
    ...
    Spring.SendCommands("luaui enablewidget TAP cmdcolors")
    ...
    Spring.SendCommands("luaui enablewidget External VR Grid")
    ...
    Spring.SendCommands("luaui enablewidget TAP LOS colors")
    ...
    Spring.SendCommands("luaui enablewidget TAP Hotkeys")
