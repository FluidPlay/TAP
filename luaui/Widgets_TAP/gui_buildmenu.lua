		...
		while colls <= maxC do
			...
			for id, unit in pairs(UnitDefs) do
				...
				if unitIconType[id] and iconTypesMap[unitIconType[id]] then
					gl.TexRect(-1, -1, 0, 0)
					--TODO: MaDDoX || gl.Texture(':lr' .. newRadariconTextureDetail .. ',' .. newRadariconTextureDetail .. ':' .. iconTypesMap[unitIconType[id]])
					gl.TexRect(-1, -1, 0, 0)
					if radariconTextureDetail then	-- delete old texture
						--TODO: MaDDoX || gl.DeleteTexture(':lr' .. radariconTextureDetail .. ',' .. radariconTextureDetail .. ':' .. iconTypesMap[unitIconType[id]])
					end
				end
				gl.Texture(false)
			end
