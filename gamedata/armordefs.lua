local armorDefs = {
	robot = { "armack","armch","armck","armfark","armpw","armrectr","armsubk","armconsul","coraca","corack","corak",
			  "coramph","corck","cornecro","corspy","corsub","armfast", "corsktl", "corpyro",
	...
	vehicle = {		"armflash", "armyork", "corsent", "cormuskrat", "cormls", "armacv", "armcv", "armmls", "coracv", "corfast",
					   ...
					   "armlatnk","armfav","armjanus","armsh","armspy","coresupp","corst",
					   "corlevlr","corsh","decade","marauder","nsaclash","armfido","armmart","armsam", "cormist",
					   "armmerl","corcat","armshock","cormart","corwolv","corjugg","shiva","tawf013",
	...
	armorveh={"armanac","armbull","armcroc","armlun","armscab","armseer","armstump","armthovr",
			  ...
			  "armintr","armmanni", "armjam",},
	--lightveh = {
	--	"armflash", "armyork", "corsent", "cormuskrat", "cormls", "armacv", "armcv", "armmls", "coracv", "corfast",
	--	"critter_ant", "critter_duck", "critter_goldfish", "critter_gull", "critter_penguin", "corcv", "corgator",
	--   "armlatnk","armfav","armjanus","armmlv","armsh","armspy","coresupp","corst",
	--   "corlevlr","corsh","decade","marauder","nsaclash",
	--},
	--supportveh = {"armfido","armmart","armsam", "cormist", "armmerl","corcat","armshock","cormart","corvroc",
	...
	armorair={"corbw","armaca","armawac","armca","armcsa","armsehak","armsfig","corawac","corca",
	...
	structure = {"armsolar", "corsolar", "armmex", "cormex", "armmoho", "cormoho","armfus","corfus","armafus","corafus",
				 ...
				 "corshroud","corsonar","corsy","cortron","coruwadves","coruwadvms","coruwes","coruwfus","coruwmmm","coruwms",
	...
	defense = {"armvulc","armamb","armamd","armclaw","armdl","armdrag","armemp","armfhlt","armguard","armhlt","armllt",
			   "armpb","corbhmth","corbuzz","corexp","corfgate","corfhlt","corfmd","corgate",
			   "corhlt","corllt","corhllt","corpun","cortoast","corvipe","hllt","armbeamer","armbrtha","corint","armamex",
			   "armrl","armatl","armcir","armdeva","armfflak","armflak","armfrt","coratl","corenaa","corerad",
			   "corfrt","corrl","armmercury","corscreamer","cordoom","armanni","armptl","corptl","armtl","cortl",
			   "armkamturret", "corbwturret",
	},
	--defense={"armvulc","armamb","armamd","armclaw","armdl","armdrag","armemp","armfhlt","armguard","armhlt","armllt","armpb","corbhmth","corbuzz","corexp","corfgate","corfhlt","corfmd","corgate","corhlt","corllt","corhllt","corpun","cortoast","corvipe","hllt","armbeamer","armbrtha","corint","armamex",},
	--
	--defenseaa={"armrl","armatl","armcir","armdeva","armfflak","armflak","armfrt","coratl","corenaa","corerad","corfrt","corrl","armmercury","corscreamer","cordoom","armanni","armptl","corptl","armtl","cortl",},
	--
