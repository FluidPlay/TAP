...
local damageMultipliers = {
    ...
    laser = { 	robot = 1.5, vehicle = 0.5, air = 0.5, ship = 1, armorbot = 0.75, armorveh = 0.25, armorair = 1.5, armorship = 0.5,
    ...
    cannon  = { robot = 0.15, vehicle = 1.2, air = 1.3, ship = 1.5, armorbot = 0.6, armorveh = 1.0, armorair = 1.3, armorship = 1.5,
                structure = 1.2, defense = 0.33, commander = 0.75, shield = 1, superunit = 0.7, ore = 0, },

    flak    = { robot = 0.4, vehicle = 0.4, air = 1.0, ship = 1.0, armorbot = 2.0, armorveh = 0.3, armorair = 0.5, armorship = 0.75,
                structure = 0.5, defense = 0.6, commander = 0.20, shield = 2, superunit = 2.5, ore = 0, },
    ...
    pierce = { 	robot = 0.2, vehicle = 0.45, air = 1.3, ship = 1.5, armorbot = 0.4, armorveh = 3.5, armorair = 2.0, armorship = 2.4,
                structure = 0.75, defense = 0.2, commander = 0.5, shield = 1.5, superunit = 0.5, ore = 0, },
    ...
    plasma = { 	robot = 1.1, vehicle = 0.5, air = 1, ship = 1.5, armorbot = 0.6, armorveh = 0.4, armorair = 1.5, armorship = 1.5,
                structure = 1.4, defense = 0.6, commander = 0.85, shield = 1, superunit = 0.75, ore = 0, },
    ...
    photon = { 	robot = 0.9, vehicle = 0.6, air = 3, ship = 2, armorbot = 0.75, armorveh = 0.25, armorair = 2, armorship = 0.25,
                structure = 1.2, defense = 1.4, commander = 0.25, shield = 1, superunit = 1, ore = 0, },
    ...
    emp = { robot = 1, vehicle = 1.6, air = 1, ship = 1.75, armorbot = 3, armorveh = 4.5, armorair = 1, armorship = 4,
            structure = 0.75, defense = 0.75, commander = 0.1, shield = 1, superunit = 0.33, ore = 0, },
    ...
    omni = { 	robot = 1, vehicle = 0.65, air = 1.5, ship = 1.25, armorbot = 1.1, armorveh = 2, armorair = 2, armorship = 2.5,
                structure = 0.5, defense = 0.75, commander = 0.75, shield = 1, superunit = 1.5, ore = 0, }, --commander 0.4

	explosion = { 	robot = 1.2,  vehicle = 0.55, air = 1, ship = 3, armorbot = 1.1, armorveh = 0.7, armorair = 0.5, armorship = 3,
					structure = 1.25, defense = 0.55, commander = 0.18, shield = 1, superunit = 2, ore = 0.5,},
    ...
    harvest = { 	robot = 0, vehicle = 0, air = 0, ship = 0, armorbot = 0, armorveh = 0, armorair = 0, armorship = 0,
                structure = 0, defense = 0, commander = 0, shield = 0, superunit = 0, ore = 0.08, },
