...
local damageMultipliers = {
    ...
    cannon  = { robot = 0.5, vehicle = 1.2, air = 1.3, ship = 1.5, structure = 1.2, defense = 0.33, commander = 0.75, shield = 1, superunit = 0.7, ore = 0.1, },
    ...
    omni = { 	robot = 1, vehicle = 0.65, air = 1.5, ship = 1.25, structure = 0.5, defense = 0.75, commander = 0.75, shield = 1, superunit = 1.5, ore = 0.08, },
