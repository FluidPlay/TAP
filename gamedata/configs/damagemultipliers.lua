...
local damageMultipliers = {
    ...
    laser = { 	robot = 2, vehicle = 0.5, air = 0.5, ship = 1, armorbot = 0.75, armorveh = 0.25, armorair = 1.5, armorship = 0.5,
                structure = 0.6, defense = 0.15, armordefense = 0.25, commander = 0.4, shield = 1, superunit = 1, ore = 0, guardian = 0.3, },
    ...
    pierce = { 	robot = 0.2, vehicle = 0.3, air = 0.65, ship = 1.5, armorbot = 0.5, armorveh = 3.5, armorair = 2.0, armorship = 2.4,
                structure = 0.75, defense = 0.25, armordefense = 0.5, commander = 0.5, shield = 1.5, superunit = 0.5, ore = 0, guardian = 0.4, },
    ...
    plasma = { 	robot = 1.1, vehicle = 0.5, air = 1, ship = 1.5, armorbot = 0.6, armorveh = 0.3, armorair = 1.5, armorship = 1.5,
                structure = 1.4, defense = 0.3, armordefense = 0.6, commander = 0.85, shield = 1, superunit = 0.75, ore = 0, guardian = 0.4, },
