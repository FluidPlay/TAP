...
local damageMultipliers = {
    ...
    laser = { 	robot = 1.75, vehicle = 0.75, air = 0.75, ship = 1, structure = 0.6, defense = 0.2, commander = 0.4, superunit = 1, },
    ...
    thermo = { 	robot = 1.1, vehicle = 0.9, air = 1.25, ship = 1, structure = 0.5, defense = 0.3, commander = 0.3, superunit = 0.7, },
    ...
    emp = { robot = 1, vehicle = 1.6, air = 1, ship = 1.75, structure = 0.75, defense = 0.75, commander = 0.1, superunit = 0.33, },
    ...
    omni = { 	robot = 1, vehicle = 1, air = 1.5, ship = 1.25, structure = 0.5, defense = 0.75, commander = 0.75, superunit = 1.5, },
    ...
    none={ 		robot = 0.1,  vehicle = 0.1, air = 0.1, ship = 0.1, structure = 0.1, defense = 0.1, commander = 0.1, superunit = 0.1, },
