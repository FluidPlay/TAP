...
local damageMultipliers = {
    ...
    laser = { 	robot = 1.5, vehicle = 0.75, air = 0.75, ship = 1, structure = 0.6, defense = 0.2, commander = 0.4, shield = 1, superunit = 1, },
    ...
    bullet  = { robot = 0.8, vehicle = 0.5, air = 1.1, ship = 0.4, structure = 0.8, defense = 0.33, commander = 0.20, shield = 1, superunit = 0.6, },
    cannon  = { robot = 0.35, vehicle = 1.2, air = 1.3, ship = 1.5, structure = 1.2, defense = 0.33, commander = 0.75, shield = 1, superunit = 0.7, },
    flak    = { robot = 1.3, vehicle = 0.3, air = 1.0, ship = 1.0, structure = 0.5, defense = 0.33, commander = 0.20, shield = 2, superunit = 2.5, },
    ...
    pierce = { 	robot = 0.3, vehicle = 2.1, air = 2, ship = 1.5, structure = 0.75, defense = 0.4, commander = 0.5, shield = 1.5, superunit = 0.5, },
    ...
    plasma = { 	robot = 1.1, vehicle = 0.8, air = 1, ship = 1.5, structure = 1.4, defense = 0.6, commander = 0.85, shield = 1, superunit = 0.75, },
    --,
    ...
    --	}
    --,
    photon = { 	robot = 0.9, vehicle = 0.6, air = 1.5, ship = 2, structure = 1.2, defense = 1.4, commander = 0.25, shield = 1, superunit = 1, },
    ...
    thermo = { 	robot = 1.0, vehicle = 0.9, air = 1.25, ship = 1, structure = 0.5, defense = 0.3, commander = 0.3, shield = 0.02, superunit = 0.7, },
    ...
    emp = { robot = 1, vehicle = 1.6, air = 1, ship = 1.75, structure = 0.75, defense = 0.75, commander = 0.1, shield = 1, superunit = 0.33, },
    ...
    omni = { 	robot = 1, vehicle = 1, air = 1.5, ship = 1.25, structure = 0.5, defense = 0.75, commander = 0.75, shield = 1, superunit = 1.5, },
    ...
    none={ 		robot = 0.1,  vehicle = 0.1, air = 0.1, ship = 0.1, structure = 0.1, defense = 0.1, commander = 0.1, shield = 0.1, superunit = 0.1, },
