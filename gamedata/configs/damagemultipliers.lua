...
local damageMultipliers = {
    ...
    bullet  = { robot = 0.8, vehicle = 0.2, air = 0.9, ship = 0.4, armorbot = 0.4, armorveh = 0.3, armorair = 1.5, armorship = 0.25,
    ...
    pierce = { 	robot = 0.2, vehicle = 0.5, air = 1.3, ship = 1.5, armorbot = 0.4, armorveh = 3, armorair = 2, armorship = 2.4,
