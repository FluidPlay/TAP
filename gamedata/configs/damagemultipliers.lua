...
local damageMultipliers = {
    ...
    flak    = { robot = 0.4, vehicle = 0.4, air = 0.6, ship = 1.0, armorbot = 1.3, armorveh = 0.3, armorair = 0.5, armorship = 0.75,
                structure = 0.5, defense = 0.6, armordefense = 0.25, commander = 0.20, shield = 2, superunit = 2.5, ore = 0, guardian = 0.15, },
