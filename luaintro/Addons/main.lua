...
local tips = {
	...
	"Kern/corgat.dds ".."Gatlings and Flares are terrific anti-bot vehicles, very EMP-resistant and moderately effective against lighter gunships. When facing tanks or combos of plasma and missile bots, don't expect them to last long.",
    ...
    "Bow/armbrawl.dds ".."Bow's gunship is the Bully. It fires unlimited laser rounds, making it a great anti-bot unit. Even with its low-altitude, more vulnerable flight mode, the Bully is faster than the Kern's Rapier.",
