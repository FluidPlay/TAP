...
local tips = {
    ...
    "Bow/armfav.dds ".."Bow Pokers and Kern Lancers are excellent at running over rifle bots (Uzi, Bro), but are not heavy enough to crush missile or plasma bots. Keep this in mind if your opponent decides to spam those cheaper units like there's no tomorrow - then make sure he's right. ;)",
    ...
    "Bow/armpw.dds ".."The Bro (Bow T1 assault bot) may acquire a special ability once you get to Tech 2, the EMP grenade. It's researched per-unit and lobs a mid-range bouncing projectile, quite effective vs bots and defenses. To use it, Hit 'D' and left-click on target.",
...
local unit_descs = {
	...
	"Bow/armrock.dds "..titleColor.."Hunter (BOW T1 bot)\n"..contentColor.."Light rocket bot excellent vs tanks and with good damage against defenses. Mixed with plasma bots they form a great combo vs defense towers. Watch out for rifle bots (Uzi/Bro)",
	...
	--"Kern/corak.dds "..titleColor.."Uzi (KERN T1 bot)\n"..contentColor.."Light infantry bot which is cheap and quick to build. It is armed with a light, but precise laser which outranges the Bro.",
	...
	--"Bow/armflash.dds "..titleColor.."Flare (BOW T1 Vehicle)\n"..contentColor.."A light, fast tank with close combat rapid fire weapon. Slightly more powerful and faster than Bros and Uzis on flat terrain.",
	...
	--"Kern/corlevlr.dds "..titleColor.."Lancer (KERN T1 Vehicle) \n"..contentColor.."Powerful tank armed with an impulse weapon that deals AoE damage and repels light units. It makes it highly effective against swarms of Bros, Flares etc.",
