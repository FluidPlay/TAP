...
local tips = {
    ...
    "armfav.dds ".."Bow Pokers and Kern Lancers are excellent at running over rifle bots (Uzi, Bro), but are not heavy enough to crush missile or plasma bots. Keep this in mind if your opponent decides to spam those cheaper units like there's no tomorrow - then make sure he's right. ;)",
    ...
    "armpw.dds ".."The Bro (Bow T1 assault bot) may acquire a special ability once you get to Tech 2, the EMP grenade. It's researched per-unit and lobs a mid-range bouncing projectile, quite effective vs bots and defenses. To use it, Hit 'D' and left-click on target.",
