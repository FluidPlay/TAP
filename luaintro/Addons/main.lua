...
local tips = {
    ...
    "armfav.dds ".."Bow Pokers and Kern Lancers are excellent at running over rifle kbots (Uzi, Tweeny), but are not heavy enough to crush missile or plasma kbots. Keep this in mind if your opponent decides to spam those cheaper units like there's no tomorrow - then make sure he's right. ;)",
...
local unit_descs = {
	...
	"armrock.dds "..titleColor.."Hunter (BOW T1 Kbot)\n"..contentColor.."Light rocket Kbot excellent vs tanks and with good damage against defenses. Mixed with plasma kbots they form a great combo vs defense towers. Watch out for rifle bots (Uzi/Tweeny)",
	...
	--"corak.dds "..titleColor.."Uzi (KERN T1 Kbot)\n"..contentColor.."Light infantry Kbot which is cheap and quick to build. It is armed with a light, but precise laser which outranges the Tweeny.",
