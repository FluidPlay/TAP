...
local tips = {
    ...
    "armsam.dds ".."The Bow Bastion has a special ability, the Fire Rain. It's researched per-unit (requires Tier 2 Tech) and lobs multiple fire shells, damaging bots and vehicles in a wide area. Hit 'D' and left-click on target to use it.",
    ...
    "armpw.dds ".."The Tweeny (Bow T1 assault bot) may acquire a special ability once you get to Tier 2, the EMP grenade. It's researched per-unit and lobs a mid-range bouncing projectile, quite effective vs bots and defenses. To use it, Hit 'D' and left-click on target.",
    ...
    "corgol.dds ".."Tanks can crush lighter enemy bots, like rifle and missile bots. Tier 4 tanks can crush dragon teeth, and the Tier 5 Hercules can even crush Tier 2 Tanks.",
...
local unit_descs = {
    ...
    "corjugg.dds "..titleColor.."Experimental Ultra Heavy bot: \n"..contentColor.."Barely mobile, the Mammoth packs the heaviest weapon of all the experimental bots, able to take out mobs of units, Titans and Kolossuss with ease. Watch out for long-ranged, heavy damage weaponry, they totally ruin a Jugg's day.",
