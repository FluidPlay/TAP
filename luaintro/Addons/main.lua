...
local tips = {
    "corhrk.dds ".."Some units can only be obtained by morph, like the Kern Hunchback (T4 Flak Artillery, morphed from Mortars) and the Bow Thor (T5 Thermo Kbot, morphed from Rogues).",
    ...
    "armaak.dds ".."The Bow Seraph (Tier 4) and the Kern Sphinx (Tier 5) fire long range missiles. Like all AA (anti-air) missiles, it's great vs bombers but not so much against fighters.",
	"outpost.dds ".."To build unit factories you need an Outpost. Outposts can morph up to Tier 6, with increasingly better build range and LOS.",
    ...
    "armshltx.dds ".."To build experimental units like the Kolossus and Titan, you need an Experimental Gantry, built exclusively by a Level 4 outpost",
    ...
    "armawin.dds ".."When the wind is blowing in your favor, Advanced Wind Generators are available on Tier 4 as morphs from the regular Wind Generator.",
	...
	"corgat.dds ".."Gatlings and Flares are terrific anti-kbot vehicles, very EMP-resistant and moderately effective against lighter gunships. When facing tanks or combos of plasma and missile kbots, don't expect them to last long.",
    "corlevlr.dds ".."Kern Lancers and Bow Pokers are early game assault units. One of their unique abilities is the capacity to dodge kbot missiles when properly microed and kept moving at their top speed. Lancers can also transport kbots, including builders",
    "corlevlr.dds ".."The Kern Lancer, besides having a weapon with good splash, is able to transport up to two light kbots - including builders. Hint: even allied builders can be transported.",
    "armfav.dds ".."Bow Pokers and Kern Lancers are excellent at running over rifle kbots (Uzi, Gunner), but are not heavy enough to crush missile or plasma kbots. Keep this in mind if your opponent decides to spam those cheaper units like there's no tomorrow - then make sure he's right. ;)",
    ...
    "armsam.dds ".."The Bow Bastion has a special ability, the Fire Rain. It's researched per-unit (requires Tier 2 Tech) and lobs multiple fire shells, damaging kbots and vehicles in a wide area. Hit 'D' and left-click on target to use it.",
    "corvrad.dds ".."The Kern Sage special ability is the Neutron Strike. It's researched per-unit (requires Tier 2 Tech) and requires 400 metal to fire, but it's absolutely devastating against vehicles. Not to mention the psychological effect on the enemy.",
    "corvrad.dds ".."Kern's Sage, besides its amazing line of sight, can also resurrect units. To unlock it, simply research the Global 'resurrect' upgrade in a Tier 1 Tech Center.",
    "armpw.dds ".."The Tweeny (Bow T1 assault bot) may acquire a special ability once you get to Tier 2, the EMP grenade. It's researched per-unit and lobs a mid-range bouncing projectile, quite effective vs kbots and defenses. To use it, Hit 'D' and left-click on target.",
    "armpnix.dds ".."Advanced Bombers (Tier 4+) cruise flight is higher than the Tier 1 and Tier 2 AA units and defenses ranges. You can use this to safely fly over most defenses and scout or hit deep within enemy territory.",
	"armmex.dds ".."Metal Extractors can be morphed into Adv. Metal Extractors at Tier 3, Moho Mexes at Tier 4 and Uber Mexes at Tier 5, with increasingly higher metal output",
    ...
    "corgol.dds ".."Tanks can crush lighter enemy kbots, like rifle and missile kbots. Tier 4 tanks can crush dragon teeth, and the Tier 5 Hercules can even crush Tier 2 Tanks.",
    "armmine3.dds ".."Pokers, Bow's basic assault vehicle, can build land mines, great vs kbots, and bar mines, excellent vs vehicles.",
    ...
    "cormort.dds ".."Powerful artillery units are available after you upgrade your Tech Center to Level 1. Kern's Mortar is built from the kbot lab, Bow Ruger from the Vehicle Plant.",
    ...
    "corbw.dds ".."Wasps and Banshees are Kern and Bow's drones respectively. They're available on Tier 1 air plants and in spite of their mobility, don't have a great line of sight and fly low, meaning they can be hit by any ground unit.",
    ...
    "Tier 1 (starting) builder units can not assist the production of factories, unlike their advanced (Tier 4) counterparts. Morph them into Adv. builders as soon as you can.",
...
local unit_descs = {
    ...
    "corkrog.dds "..titleColor.."Experimental Very Heavy Kbot: \n"..contentColor.."Albeit slow, the Kolossus is the largest experimental kbot of all, and may win a war by itself - especially if it doesn't try to face too many experimental assault kbots, that'd be a huge waste of metal.",
    "corjugg.dds "..titleColor.."Experimental Ultra Heavy Kbot: \n"..contentColor.."Barely mobile, the Mammoth packs the heaviest weapon of all the experimental kbots, able to take out mobs of units, Titans and Kolossuss with ease. Watch out for long-ranged, heavy damage weaponry, they totally ruin a Jugg's day.",
    ...
    "outpost.dds "..titleColor.."Pro Tip: \n"..contentColor.."Morphs in progress won't be interrupted if the Tech Center is destroyed. Start morphing a distant outpost to Tier 4 (if you didn't yet) if you feel you can't save the Tech Center at main.",
    "armtech.dds "..titleColor.."Pro Tip: \n"..contentColor.."Losing your Tier2+ Tech Center won't throw you back to the stone age if you managed to morph at least one Outpost to Tier 4. (and keep it alive, ofc!)",
    "armack.dds "..titleColor.."Adv. Builder (BOW T4):\n"..contentColor.."Advanced Builders can assist factory production, just like outposts, commanders and FARKs. Building (or morphing) a couple beforehand might save you from total disaster if you lose your T4 Tech Center.",
	...
	--"armflash.dds "..titleColor.."Flare (BOW T1 Vehicle)\n"..contentColor.."A light, fast tank with close combat rapid fire weapon. Slightly more powerful and faster than Gunner and Uzi on flat terrain.",
	...
	--"corlevlr.dds "..titleColor.."Lancer (KERN T1 Vehicle) \n"..contentColor.."Powerful tank armed with an impulse weapon that deals AoE damage and repels light units. It makes it highly effective against swarms of Gunners, Flares etc.",
