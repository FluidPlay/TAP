...
local tips = {
    "Bow/armsolar.dds ".."You may order your builder or outpost to build structures in an array-like pattern by holding SHIFT+ALT and dragging with the left mouse button. Spread them up by hitting 'T' on keyboard while the Shift key is held. Ctrl+Shift+T brings them closer.",
    "Bow/armwin.dds ".."Wind Generators built on high ground have a bonus compared to units built closer to the sea level. Isn't nature beautiful?",
    "Bow/armfdrag.dds ".."Dragon Teeth can block low-height missiles, bullets and laser shots, like those from basic bots. Shark Teeth only block ships movement.",
    "Bow/armdrag.dds ".."Artillery is great to break frontline stalemates, but they'll inevitably attract a 'payback wave' after they start firing. Before you start, try and wall-in your towers there and create a 'choke wall' with dragon teeth to turn the odds in your favor.",
    "Bow/armyork.dds ".."Flak-weaponry units, like the Claw, fire scattered projectiles. Flak is excellent at taking out fighters and heavy infantry, but will barely scratch tanks and aren't very effective vs heavy air, light or support bots.",
    "Bow/armcom.dds ".."The D-Gun is the Commander's manual-fire ability and the most powerful weapon in the game, one-shotting even huge experimental T6 units. Upgrade it in the commander menu after your Tech Center is level 2, then use it with the 'D' keyboard shortcut. Level 3+ Commanders get the D-Gun by default.",
    "Kern/corhrk.dds ".."Some units can only be obtained by morph, like the Kern Hunchback (T4 Flak Artillery, morphed from Mortars) and the Bow Thor (T5 Thermo bot, morphed from Rogues).",
    "Kern/corshark.dds ".."Certain units are built in groups of two or more. Their description will show, ie. [x2] so you can know about it, and the cost shown is the total for all units. You retain individual control after they're built.",
    "Kern/cordrag.dds ".."Bow and Kern's Dragon Teeth (DTs) are great to surround perimeters, preventing lower-tech units movement. They also block incoming direct-fire and missiles from going through, so improve your defenses resistance by surrounding them with DTs.",
    "Kern/corcom.dds ".."The Commander explosion radius is large, but the heavy EMP aftershock radius is much larger and very long lasting. It's a valid strategy to sacrifice you commander and have an army waiting to take out the remaining enemy units.",
    "Bow/armaak.dds ".."The Bow Seraph (Tech 4) and the Kern Sphinx (Tech 5) fire long range missiles. Like all AA (anti-air) missiles, it's great vs bombers but not so much against fighters.",
	"Bow/bowoutpost.dds ".."To build unit factories you need an Outpost. Outposts can morph up to Tech 6, with increasingly better build range and LOS.",
    "Bow/armsilo.dds ".."It's not just about upgrading the Tech Center! Keep upgrading your outpost. Building structures from it is much cheaper than morphing, and it'll build exclusive structures like Obliterators, Nukes and EMP Launchers.",
    "Bow/armshltx.dds ".."To build super units like the Kern Khorvid and Bow Titan, you need a Super-unit plant, built exclusively by a Level 6 outpost",
    "Kern/corafus.dds ".."The 'AFUS' or Advanced Fusion Reactor has the best energy output in your army. You can get AFUSes by morphing a regular Fusion Plant, once you're Tech Level 4",
    "Bow/armawin.dds ".."When the wind is blowing in your favor, Advanced Wind Generators are available on Tech 4 as morphs from the regular Wind Generator.",
    "Kern/cormuskrat.dds ".."FARCs and Muskrats are units built directly by the Outpost. They're great for early scout, can build dragon eyes (stealth remote cameras) and may assist factories (faster unit production speed).",
    "Bow/bowoutpost.dds ".."Outposts can speed up any construction, but they're less cost effective for that than FARCs (built by the outpost) and they spend energy continuously.",
	"Bow/armtech.dds ".."To tech up, build a Tech Center, then upgrade it progressively until Tech 6. This unlocks high-tech upgrades in factories and outposts as well.",
	"Bow/armtech.dds ".."When under attack, Tech Centers can become 70% more resistant if disabled (ON/OFF button or Ctrl+X shortcut)",
    "Kern/corraid.dds ".."Vehicles become progressively slower when they drop below 45% health. Use that for your advantage, to prevent them from using hit-and-run tactics effectively.",
	"Kern/corgat.dds ".."Gatlings and Flares are terrific anti-kbot vehicles, very EMP-resistant and moderately effective against lighter gunships. When facing tanks or combos of plasma and missile bots, don't expect them to last long.",
    "Kern/corlevlr.dds ".."Kern Lancers and Bow Pokers are early game assault units. One of their unique abilities is the capacity to dodge bot missiles when properly microed and kept moving at their top speed. Lancers can also transport bots, including builders",
    "Kern/corlevlr.dds ".."The Kern Lancer, besides having a weapon with good splash, is able to transport up to two light bots - including builders. Hint: even allied builders can be transported.",
    "Bow/armfav.dds ".."Bow Pokers and Kern Lancers are excellent at running over rifle bots (Uzi, Peevee), but are not heavy enough to crush missile or plasma bots. Keep this in mind if your opponent decides to spam those cheaper units like there's no tomorrow - then make sure he's right. ;)",
	"Bow/armrl.dds ".."Missile towers can shoot at both ground and air units, but their anti-air range and damage is much higher than when firing on land units. Nevertheless, they're the best early static response to assault vehicles and tanks.",
    "Bow/armsam.dds ".."The Bow Bastion has a special ability, the Fire Rain. It's researched per-unit (requires Tech 2) and lobs multiple fire shells, damaging bots and vehicles in a wide area. Hit 'D' and left-click on target to use it.",
    "Kern/corvrad.dds ".."The Kern Sage special ability is the Neutron Strike. It's researched per-unit (requires Tech 2) and requires 400 metal to fire, but it's absolutely devastating against vehicles. Not to mention the psychological effect on the enemy.",
    "Kern/corvrad.dds ".."Kern's Sage, besides its amazing line of sight, can also resurrect units. To unlock it, simply research the Global 'resurrect' upgrade in a Tech 2 Tech Center.",
    "Bow/armpw.dds ".."The Peevee (Bow T1 assault bot) may acquire a special ability once you get to Tech 2, the EMP grenade. It's researched per-unit and lobs a mid-range bouncing projectile, quite effective vs bots and defenses. To use it, Hit 'D' and left-click on target.",
    "Bow/armpnix.dds ".."Advanced Bombers (Tech 4+) cruise flight is higher than the Tech 1 and Tech 2 AA units and defenses ranges. You can use this to safely fly over most defenses and scout or hit deep within enemy territory.",
	"Bow/armmex.dds ".."Sprawlers can be morphed into Adv. Sprawlers at Tech 3, Moho Sprawlers at Tech 4 and Uber Sprawlers at Tech 5, yielding increasingly bigger ore chunks, which provide more resources",
    ...
    "Kern/corgol.dds ".."Tanks can crush lighter enemy bots, like rifle and missile bots. Tech 4 tanks can crush dragon teeth, and the Tech 5 Hercules can even crush Tech 2 Tanks.",
    "Bow/armmine3.dds ".."Pokers, Bow's basic assault vehicle, can build land mines, great vs bots, and bar mines, excellent vs vehicles.",
	"Bow/armrad.dds ".."Radars are cheap and their detection range is much larger than their vision range. In the early game, Commanders and Outposts are your best options for true vision range.",
    "Kern/corape.dds ".."The Rapier is Kern's gunship. It holds plenty of missile ammo and excels against most vehicles. Like all gunships, it's specially vulnerable to missile trucks.",
    "Bow/armbrawl.dds ".."Bow's gunship is the Bully. It fires unlimited laser rounds, making it a great anti-kbot unit. Even with its low-altitude, more vulnerable flight mode, the Bully is faster than the Kern's Rapier.",
    "Bow/armgeo.dds ".."Abandoned/Neutral Geothermals might be scattered around the map and provide plenty of energy. You can capture them with commanders or with builders, after you research the 'capture' upgrade in the Tech Center.",
    "Kern/cormort.dds ".."Powerful artillery units are available after you upgrade your Tech Center to Level 1. Kern's Mortar is built from the bot lab, Bow Ruger from the Vehicle Plant.",
    "Bow/armpship.dds ".."Position your naval units properly during engagements. Missile ships are stronger at their rear area, while other ships are stronger at the front. Submarines are up to two times stronger at the front.",
    "Kern/corbw.dds ".."Wasps and Banshees are Kern and Bow's drones respectively. They're available on Tech 1 air plants and in spite of their mobility, don't have a great line of sight and fly low, meaning they can be hit by any ground unit.",
    "Kern/cormist.dds ".."Missile Trucks (Bow Bastion & Kern Slayer) are very expensive but a) never miss, b) outrange some defenses and c) are the best early-game mobile ground counters to air units.",
    "Kern/corrad.dds ".."To know what enemy units are vulnerable to a certain unit you have, point to your unit and hold SHIFT. Colored circles will show up below units on screen. Green means vulnerable to the pointed unit, Red means resistant to it, and so on.",
    "Bow/armmark.dds ".."The highest relatively to the ground a unit is, the further it can see (LOS). The T1 Spotter is one of the best scouts in the game, besides cloaking it's able to climb steep hills and easily acquire a nice vantage point.",
    "Kern/corshad.dds ".."You can 'air freeze' your bombers if they're set to 'Fly' mode. Simply issue a move order and hit 'S' (Stop). They'll turn to that position and hover on the spot.",
    ...
    "Bow/armmart.dds ".."Some tanks and long-ranged vehicles can move in reverse if you press 'Ctrl' while issuing a move order behind it. Use this to keep firing while retreating.",
    "Kern/corshad.dds ".."Use the air freeze ability (set to 'fly', move then stop) of bombers to group them close and looking at the enemy's direction. This way they'll all hit the target at the same time, maximizing efficiency.",
