...
local tips = {
    "corhrk.dds ".."Some units can only be obtained by morph, like the Kern Hunchback (T2 Flak Artillery, morphed from Mortars) and the Bow Thor (T3 Thermo Kbot, morphed from Rogues).",
    ...
    "armaak.dds ".."The Bow Seraph (Tier 2) and the Kern Sphinx (T3) fire long range missiles. Like all AA (anti-air) missiles, it's great vs bombers but not so much against fighters.",
    ...
    "armsam.dds ".."The Bow Bastion has a special ability, the Fire Rain. It's researched per-unit (requires Tier1 Tech) and lobs multiple fire shells, damaging kbots and vehicles in a wide area. Hit 'D' and left-click on target to use it.",
    "corvrad.dds ".."The Kern Sage special ability is the Neutron Strike. It's researched per-unit (requires Tier1 Tech) and requires 400 metal to fire, but it's absolutely devastating against vehicles. Not to mention the psychological effect on the enemy.",
    ...
    "armpw.dds ".."Gunners may acquire a special ability once you get to Tier 1, the EMP grenade. It's researched per-unit and lobs a mid-range bouncing projectile, quite effective vs kbots and defenses. To use it, Hit 'D' and left-click on target.",
    ...
    "corgol.dds ".."Tanks can crush lighter enemy kbots, like rifle and missile kbots. Tier 2 tanks can crush dragon teeth, and the Tier 3 Hercules can even crush Tier 2 Tanks.",
    ...
    "corbw.dds ".."Wasps and Banshees are Kern and Bow's drones respectively. They're available on Tier 0 air plants and in spite of their mobility, don't have a great line of sight and fly low, meaning they can be hit by any ground unit.",
    ...
    --"cormist.dds ".."Missile Trucks (Bow Bastion & Kern Slayer) are very expensive but a) never miss, b) outrange some defenses and d) are the best early-game mobile counters to air units.",
