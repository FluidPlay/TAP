...
local scriptEnv = { base = base,
					...
					explodePartsDefault = { cover_extension, left_boxcover, right_boxcover },
					explodePartsStandard = { left_head, right_head, right_pointer, left_arm },
					explodePartsAdvanced = { left_pointer1, right_pointer2, left_head_advanced, right_pointer1, left_pointer2 },
	--
					ipairs = ipairs,
					unitID = unitID,
