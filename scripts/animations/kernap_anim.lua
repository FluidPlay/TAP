...
local function openstd()
	initTween({veryLastFrame=30,
			   [right_cover]={
				   [1]={cmd="turn", axis=x_axis, targetValue=-2.35, firstFrame=0, lastFrame=30,},
			   },
			   [left_cover]={
				   [1]={cmd="turn", axis=y_axis, targetValue=2.35, firstFrame=0, lastFrame=30,},
			   },
	})
end
...
local function closestd()
	initTween({veryLastFrame=20,
			   [right_cover]={
				   [1]={cmd="turn", axis=x_axis, targetValue=0, firstFrame=0, lastFrame=20,},
			   },
			   [left_cover]={
				   [1]={cmd="turn", axis=y_axis, targetValue=0, firstFrame=0, lastFrame=20,},
			   },
	})
