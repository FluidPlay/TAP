...
local function anim3()
    initTween({veryLastFrame=48,
               ...
               [left_arm2_advanced]={
                   [1]={cmd="turn", axis=z_axis, targetValue=-2.164208, firstFrame=12, lastFrame=36,},
               },
               [left_arm3_advanced]={
                   [1]={cmd="turn", axis=z_axis, targetValue=2.617994, firstFrame=12, lastFrame=36,},
               },
               [left_head_advanced]={
                   [1]={cmd="turn", axis=z_axis, targetValue=0.575959, firstFrame=12, lastFrame=40,},
               },
               [right_arm2_advanced]={
                   [1]={cmd="turn", axis=z_axis, targetValue=2.164208, firstFrame=16, lastFrame=40,},
               },
               [right_arm3_advanced]={
                   [1]={cmd="turn", axis=z_axis, targetValue=-2.827433, firstFrame=16, lastFrame=40,},
               },
               [right_head_advanced]={
                   [1]={cmd="turn", axis=z_axis, targetValue=0.104720, firstFrame=16, lastFrame=40,},
               },
               [left_back_extension]={
                   [1]={cmd="move", axis=z_axis, targetValue=-18.000000, firstFrame=0, lastFrame=48,},
               },
               ...
               [right_back_upgrade]={
                   [1]={cmd="move", axis=x_axis, targetValue=-3.000000, firstFrame=20, lastFrame=48,},
               },
               [left_back_upgrade]={
                   [1]={cmd="move", axis=x_axis, targetValue=3.000000, firstFrame=20, lastFrame=48,},
               },
...
local function anim4()
    initTween({veryLastFrame=38,
               ...
               [left_base]={
                   [1]={cmd="move", axis=x_axis, targetValue=-0.000000, firstFrame=0, lastFrame=38,},
               },
               [right_base]={
                   [1]={cmd="move", axis=x_axis, targetValue=-0.000000, firstFrame=0, lastFrame=38,},
               },
