...
local function morphup()
    initTween({veryLastFrame=52,
               [right_upgrade]={
                   ...
                   [2]={cmd="move", axis=y_axis, targetValue=-11.148439, firstFrame=0, lastFrame=40,},
                   [3]={cmd="move", axis=x_axis, targetValue=0.800000, firstFrame=40, lastFrame=48,},
               },
               [left_upgrade]={
                   [1]={cmd="show", firstFrame=0,},
                   [2]={cmd="move", axis=y_axis, targetValue=-11.148439, firstFrame=0, lastFrame=40,},
...
local function closeadv()
    initTween({veryLastFrame=44,
               [right_arm1_advanced]={
                   [1]={cmd="move", axis=x_axis, targetValue=0.254169, firstFrame=0, lastFrame=28,},
